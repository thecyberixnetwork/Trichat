 ...
 */
    ...
    #endif
#else
    #define CERT_PREFIX "/Storage/workspace/TrinityChat/wolfssl-5.9.2/wolfssl-5.9.2/"
    #define CERT_WRITE_TEMP_DIR "/Storage/workspace/TrinityChat/wolfssl-5.9.2/wolfssl-5.9.2/"
